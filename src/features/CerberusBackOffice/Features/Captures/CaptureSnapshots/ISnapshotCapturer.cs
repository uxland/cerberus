...
{
    Task<(CaptureError? Error, string? SnapshotRawPath, string? SnapshotThumbnailPath)> CaptureSnapshot(CaptureSnapshotArguments arguments, CancellationToken cancellationToken = default);
}
