...
public interface IReadModelQueryProvider
{
    ...
    public Task<string> ListAsJson<TEntity>(Specification<TEntity>? specification = null, params string[] orderBy)
    ...
    public Task<IReadOnlyList<TEntity>> List<TEntity>(Specification<TEntity>? specification = null,
