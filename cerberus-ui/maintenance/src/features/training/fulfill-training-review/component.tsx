...
export const FulfillTrainingReview = () => {
    const {id} = useParams()
    const [trainingReview, setTrainingReview] = useState<TrainingReview>(undefined)
    ...
    return(
        <div>
            ...
            {trainingReview && (<div>
                ...
                <img src={getImageUrl(trainingReview.captureInfo.snapshotUri)} alt={trainingReview.description}/>
                <form onSubmit={}></form>
            </div>)}
        </div>
    )
