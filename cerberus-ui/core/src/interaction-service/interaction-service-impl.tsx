                ...
                return (
                    <Dialog open={open} onClose={() => handleClose(false)}>
                        ...
                        <DialogActions hidden={!finalOptions.showCancelButton && !finalOptions.showConfirmButton}>
                            {finalOptions.showCancelButton && <Button onClick={() => handleClose(false)}>{finalOptions.cancelButtonText}</Button>}
                            {finalOptions.showConfirmButton && <Button onClick={() => handleClose(true)} disabled={!isValid}>{finalOptions.confirmButtonText}</Button>}
                        </DialogActions>
                    </Dialog>
                );
            }
